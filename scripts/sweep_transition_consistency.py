...
def _render_report(summary: list[dict[str, float | int]], rows: list[Row]) -> str:
    lines = [
        ...
        "",
        "| transition weight | Seeds | filter KL | edge KL | state RMSE | state NLL | pred NLL | ELBO | oracle ELBO |",
        "|---:|---:|---:|---:|---:|---:|---:|---:|---:|",
    ]
    for item in summary:
        lines.append(
    ...
    lines.extend(
        [
            ...
            "## Per-Seed Rows",
            "",
            "| Seed | transition weight | filter KL | edge KL | state RMSE | state NLL | pred NLL | ELBO | oracle ELBO |",
            "|---:|---:|---:|---:|---:|---:|---:|---:|---:|",
        ]
    )
    for row in rows:
